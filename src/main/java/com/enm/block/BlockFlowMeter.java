...
public class BlockFlowMeter extends BlockENM implements GuiRegister
{
	...
	{
		return new GuiContainerFlowMeter(pl, (TileEntityFlowMeter)te);
	}
	...
	public void registerBlockIcons(IIconRegister register)
	{
		textures = new IIcon[]
		{
			...
			register.registerIcon(CoreMod.MODID+":Fflowpanel")
		};
	}
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase player, ItemStack item)
	{
		...
		if(te instanceof TileEntityFlowMeter)
		{
			((TileEntityFlowMeter)te).inputdir = Tools.EntityLivingBaseToForgeDirection(player, true);
		}
	}
	...
	public IIcon getIcon(IBlockAccess world, int x, int y, int z, int side)
	{
		...
		if(te instanceof TileEntityFlowMeter)
		{
			TileEntityFlowMeter tes = (TileEntityFlowMeter) te;
	...
	public BlockFlowMeter(Material material)
	{
		super(material);
	}
	...
	{
		return new TileEntityFlowMeter();
	}
