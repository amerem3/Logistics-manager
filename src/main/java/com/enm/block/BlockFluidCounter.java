...
import com.enm.tileEntity.TileEntityFluidCounter;
...
public class BlockFluidCounter extends BlockENM implements GuiRegister
{
	...
	{
		return new GuiContainerFluidCounter(pl, (TileEntityFluidCounter)te);
	}
	...
	public void registerBlockIcons(IIconRegister register)
	{
		textures = new IIcon[]
		{
			...
			register.registerIcon(CoreMod.MODID+":Fcounterpanel")
		};
	}
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase player, ItemStack item)
	{
		...
		if(te instanceof TileEntityFluidCounter)
		{
			((TileEntityFluidCounter)te).inputdir = Tools.EntityLivingBaseToForgeDirection(player, true);
		}
	}
	...
	public IIcon getIcon(IBlockAccess world, int x, int y, int z, int side)
	{
		...
		if(te instanceof TileEntityFluidCounter)
		{
			TileEntityFluidCounter tes = (TileEntityFluidCounter) te;
	...
	public BlockFluidCounter(Material material)
	{
		super(material);
	}
	...
	{
		return new TileEntityFluidCounter();
	}
