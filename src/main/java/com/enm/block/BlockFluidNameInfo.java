...
import com.enm.guicontainer.GuiContainerFluidNameInfo;
import com.enm.tileEntity.TileEntityFluidNameInfo;
...
public class BlockFluidNameInfo extends BlockENM implements GuiRegister
{
	...
	{
		return new GuiContainerFluidNameInfo(pl, (TileEntityFluidNameInfo)te);
	}
	...
	public void registerBlockIcons(IIconRegister register)
	{
		textures = new IIcon[]
		{
			...
			register.registerIcon(CoreMod.MODID+":Fnameinfo")
		};
	}
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase player, ItemStack item)
	{
		...
		if(te instanceof TileEntityFluidNameInfo)
		{
			((TileEntityFluidNameInfo)te).inputdir = Tools.EntityLivingBaseToForgeDirection(player, true).getOpposite();
		}
	}
	...
	public IIcon getIcon(IBlockAccess world, int x, int y, int z, int side)
	{
		...
		if(te instanceof TileEntityFluidNameInfo)
		{
			TileEntityFluidNameInfo tes = (TileEntityFluidNameInfo) te;
	...
	public BlockFluidNameInfo(Material material)
	{
		super(material);
	}
	...
	{
		return new TileEntityFluidNameInfo();
	}
