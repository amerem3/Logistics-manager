...
import com.enm.guicontainer.GuiContainerFluidCounter;
import com.enm.guicontainer.GuiContainerGasCounter;
import com.enm.tileEntity.TileEntityGasCounter;
...
public class BlockGasCounter extends BlockENM implements GuiRegister, ModDependence
{
	...
	{
		return new GuiContainerGasCounter(pl, (TileEntityGasCounter)te);
	}
	...
	public void registerBlockIcons(IIconRegister register)
	{
		textures = new IIcon[]
		{
			...
			register.registerIcon(CoreMod.MODID+":GAScounterpanel")
		};
	}
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase player, ItemStack item)
	{
		...
		if(te instanceof TileEntityGasCounter)
		{
			((TileEntityGasCounter)te).inputdir = Tools.EntityLivingBaseToForgeDirection(player, true);
		}
	}
	...
	public IIcon getIcon(IBlockAccess world, int x, int y, int z, int side)
	{
		...
		if(te instanceof TileEntityGasCounter)
		{
			TileEntityGasCounter tes = (TileEntityGasCounter) te;
	...
	public BlockGasCounter(Material material)
	{
		super(material);
	}
	...
	{
		return new TileEntityGasCounter();
	}
