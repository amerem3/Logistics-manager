...
import com.enm.guicontainer.GuiContainerFlowMeter;
import com.enm.guicontainer.GuiContainerGasFlowMeter;
import com.enm.tileEntity.TileEntityFlowMeter;
import com.enm.tileEntity.TileEntityGasFlowMeter;
...
public class BlockGasFlowMeter extends BlockENM implements GuiRegister, ModDependence
{
	...
	{
		return new GuiContainerGasFlowMeter(pl, (TileEntityGasFlowMeter)te);
	}
	...
	public void registerBlockIcons(IIconRegister register)
	{
		textures = new IIcon[]
		{
			...
			register.registerIcon(CoreMod.MODID+":GASflowpanel")
		};
	}
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase player, ItemStack item)
	{
		...
		if(te instanceof TileEntityGasFlowMeter)
		{
			((TileEntityGasFlowMeter)te).inputdir = Tools.EntityLivingBaseToForgeDirection(player, true);
		}
	}
	...
	public IIcon getIcon(IBlockAccess world, int x, int y, int z, int side)
	{
		...
		if(te instanceof TileEntityGasFlowMeter)
		{
			TileEntityGasFlowMeter tes = (TileEntityGasFlowMeter) te;
	...
	public BlockGasFlowMeter(Material material)
	{
		super(material);
	}
	...
	{
		return new TileEntityGasFlowMeter();
	}
