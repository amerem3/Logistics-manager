...
import com.enm.itemrender.ItemRenderTerminal;
import com.enm.tileEntity.TileEntityTerminal;
import com.enm.tileEntitySpecialRenderer.TileEntitySRTerminal;
...
public class BlockTerminal extends BlockENM implements ISR, TSR, GuiRegister
{
	@Override
	...
	{
		return new GuiContainerTerminal(pl, (TileEntityTerminal)te);
	}
	
	@SideOnly(Side.CLIENT)
	public TileEntitySpecialRenderer TESpecialRenderer()
	{
		return new TileEntitySRTerminal();
	}

	@SideOnly(Side.CLIENT)
	public IItemRenderer ItemRender()
	{
		return new ItemRenderTerminal();
	}
	
	public BlockTerminal(Material material)
	{
		super(material);
