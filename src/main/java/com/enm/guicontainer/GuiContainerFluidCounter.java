...
public class GuiContainerFluidCounter extends GuiContainer
{
	TileEntityFluidCounter te_Counter;
	GuiTextField customName;
	GuiButton reset;

	public GuiContainerFluidCounter(InventoryPlayer pl, TileEntityFluidCounter te)
	{
