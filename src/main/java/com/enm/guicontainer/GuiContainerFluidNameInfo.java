...
public class GuiContainerFluidNameInfo extends GuiContainer
{

	TileEntityFluidNameInfo te_fluidnameinfo;
	GuiTextField customName;

	public GuiContainerFluidNameInfo(InventoryPlayer pl, TileEntityFluidNameInfo te)
	{
		...
		customName.setText(te_fluidnameinfo.Custom_Name);
	...
	protected void drawGuiContainerBackgroundLayer(float p_146976_1_, int p_146976_2_, int p_146976_3_)
	{
        ...
        drawString(fontRendererObj, te_fluidnameinfo.GetFluidName(), x + 8, y + 10, 0xaaaaaa);
	...
	protected void mouseClicked(int x, int y, int click)
	{
		...
		te_fluidnameinfo.Custom_Name = customName.getText();
		te_fluidnameinfo.updateInventory();
