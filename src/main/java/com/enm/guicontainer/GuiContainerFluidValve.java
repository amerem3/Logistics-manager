...
public class GuiContainerFluidValve extends GuiContainer
{
	//ResourceLocation texture = new ResourceLocation(CoreMod.MODID ,"textures/guis/rfswitch_gui.png");
	TileEntityFluidValve te_valve;
	...
	public GuiContainerFluidValve(InventoryPlayer pl, TileEntityFluidValve te)
	{
	...
	protected void drawGuiContainerBackgroundLayer(float arg1, int arg2, int arg3)
	{
        ...
        this.mc.renderEngine.bindTexture(ResourceLocationRegister.texture_valve_gui);
        int x = width / 2 - 40;
        int y = height / 2 - 40;
