...
public class GuiContainerGasCounter extends GuiContainer {

	TileEntityGasCounter te_Counter;
	GuiTextField customName;
	GuiButton reset;

	public GuiContainerGasCounter(InventoryPlayer pl, TileEntityGasCounter te)
	{
