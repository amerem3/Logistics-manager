...
public class GuiContainerGasFlowMeter extends GuiContainer
{
	TileEntityGasFlowMeter te_Flowmeter;
	GuiTextField customName;

	public GuiContainerGasFlowMeter(InventoryPlayer pl, TileEntityGasFlowMeter te)
	{
