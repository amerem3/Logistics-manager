...
public class GuiContainerSwitch extends GuiContainer
{
	...
	public GuiContainerSwitch(InventoryPlayer pl, TileEntitySwitch te)
	{
	...
	protected void drawGuiContainerBackgroundLayer(float arg1, int arg2, int arg3)
	{
        ...
        this.mc.renderEngine.bindTexture(ResourceLocationRegister.texture_rfswitch_gui);
        int x = width / 2 - 40;
        int y = height / 2 - 40;
