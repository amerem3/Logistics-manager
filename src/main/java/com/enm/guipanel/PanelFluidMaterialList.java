...
public class PanelFluidMaterialList implements GuiPanel, ActionPerformed
{
		...
		if(machines != null)
		{
			...
			for(TileEntity tem : machines)
			{
				if(id/epage == page)
				{
					...
					if(tem instanceof Machine_FluidValve)
					{
						...
						gui_terminal.drawString(fontRendererObj, "Type: "+((Machine_FluidValve)tem).name(), x2+1, y2+26, 0xffffff);
						gui_terminal.drawString(fontRendererObj, "CustomName: "+((Machine_FluidValve)tem).CustomName(), x2+1, y2+36, 0xffffff);
						gui_terminal.drawString(fontRendererObj, "Pos: ["+tem.xCoord+","+tem.yCoord+","+tem.zCoord+"]", x2+1, y2+46, 0xffffff);
						gui_terminal.drawString(fontRendererObj, ((Machine_FluidValve)tem).GetSyntaxe(), x2+1, y2+56, 0xffffff);
					...
					if(tem instanceof Machine_FluidCounter)
					{
						gui_terminal.mc.renderEngine.bindTexture(ResourceLocationRegister.texture_pixel255);
						gui_terminal.setColorRGBA(0, 128, 0, 255);
						gui_terminal.drawTexturedModalRect(x2, 25+y2, 0, 0, 150, 40);
						gui_terminal.drawString(fontRendererObj, "Type: "+((Machine_FluidCounter)tem).name(), x2+1, y2+26, 0xffffff);
						gui_terminal.drawString(fontRendererObj, "CustomName: "+((Machine_FluidCounter)tem).CustomName(), x2+1, y2+36, 0xffffff);
						gui_terminal.drawString(fontRendererObj, "Pos: ["+tem.xCoord+","+tem.yCoord+","+tem.zCoord+"]", x2+1, y2+46, 0xffffff);
						gui_terminal.drawString(fontRendererObj, ((Machine_FluidCounter)tem).GetSyntaxe(), x2+1, y2+56, 0xffffff);
					...
					if(tem instanceof Machine_FluidFlowMeter)
					{
						gui_terminal.mc.renderEngine.bindTexture(ResourceLocationRegister.texture_pixel255);
						gui_terminal.setColorRGBA(0, 0, 128, 255);
						gui_terminal.drawTexturedModalRect(x2, 25+y2, 0, 0, 150, 40);
						gui_terminal.drawString(fontRendererObj, "Type: "+((Machine_FluidFlowMeter)tem).name(), x2+1, y2+26, 0xffffff);
						gui_terminal.drawString(fontRendererObj, "CustomName: "+((Machine_FluidFlowMeter)tem).CustomName(), x2+1, y2+36, 0xffffff);
						gui_terminal.drawString(fontRendererObj, "Pos: ["+tem.xCoord+","+tem.yCoord+","+tem.zCoord+"]", x2+1, y2+46, 0xffffff);
						gui_terminal.drawString(fontRendererObj, ((Machine_FluidFlowMeter)tem).GetSyntaxe(), x2+1, y2+56, 0xffffff);
					...
					if(tem instanceof Machine_FluidStorageInfo)
					{
						gui_terminal.mc.renderEngine.bindTexture(ResourceLocationRegister.texture_pixel255);
						gui_terminal.setColorRGBA(128, 0, 128, 255);
						gui_terminal.drawTexturedModalRect(x2, 25+y2, 0, 0, 150, 40);
						gui_terminal.drawString(fontRendererObj, "Type: "+((Machine_FluidStorageInfo)tem).name(), x2+1, y2+26, 0xffffff);
						gui_terminal.drawString(fontRendererObj, "CustomName: "+((Machine_FluidStorageInfo)tem).CustomName(), x2+1, y2+36, 0xffffff);
						gui_terminal.drawString(fontRendererObj, "Pos: ["+tem.xCoord+","+tem.yCoord+","+tem.zCoord+"]", x2+1, y2+46, 0xffffff);
						gui_terminal.drawString(fontRendererObj, ((Machine_FluidStorageInfo)tem).GetSyntaxe(), x2+1, y2+56, 0xffffff);
					...
					if(tem instanceof Machine_FluidName)
					{
						gui_terminal.mc.renderEngine.bindTexture(ResourceLocationRegister.texture_pixel255);
						gui_terminal.setColorRGBA(0, 128, 128, 255);
						gui_terminal.drawTexturedModalRect(x2, 25+y2, 0, 0, 150, 40);
						gui_terminal.drawString(fontRendererObj, "Type: "+((Machine_FluidName)tem).name(), x2+1, y2+26, 0xffffff);
						gui_terminal.drawString(fontRendererObj, "CustomName: "+((Machine_FluidName)tem).CustomName(), x2+1, y2+36, 0xffffff);
						gui_terminal.drawString(fontRendererObj, "Pos: ["+tem.xCoord+","+tem.yCoord+","+tem.zCoord+"]", x2+1, y2+46, 0xffffff);
						gui_terminal.drawString(fontRendererObj, "FName: "+((Machine_FluidName)tem).GetFluidName(), x2+1, y2+56, 0xffffff);
