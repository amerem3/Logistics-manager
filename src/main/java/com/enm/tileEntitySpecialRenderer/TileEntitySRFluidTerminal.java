...
public class TileEntitySRFluidTerminal extends TileEntitySpecialRenderer
{
    
    //The model of your block
    private final ModelTerminal model;
    
    public TileEntitySRFluidTerminal()
    {
    ...
    public void renderTileEntityAt(TileEntity te, double x, double y, double z, float scale)
    {
            ...
            Minecraft.getMinecraft().renderEngine.bindTexture(ResourceLocationRegister.texture_fluid_terminal);                    
            GL11.glPushMatrix();
